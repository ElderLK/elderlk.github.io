...
const Terminal = ({ title, texts }: Props) => {
  ...
  return (
    <div className="z-10 mt-14 h-full min-h-[400px] w-full overflow-hidden rounded border bg-slate-200 p-2 dark:border-slate-700 dark:bg-zinc-900">
